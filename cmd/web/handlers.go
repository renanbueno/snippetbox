...
func (app *application) snippetSearch(w http.ResponseWriter, r *http.Request) {
	...
	snippets, err := app.snippets.Search(term)
	if err != nil {
		app.serverError(w, err)
		return
	}
...
// random
func (app *application) snippetRandom(w http.ResponseWriter, r *http.Request) {
	snippet, err := app.snippets.Random()
	if err != nil {
		app.serverError(w, err)
		return
	}
	...
	app.render(w, http.StatusOK, "random.tmpl.html", data)
}
