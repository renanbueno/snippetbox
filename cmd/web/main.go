...
func main() {
	...
	dsn := flag.String("dsn", "sql10729357:FbVcrMDiIP@tcp(sql10.freemysqlhosting.net)/sql10729357?parseTime=true", "MySQL data source name")
	...
	err = srv.ListenAndServe() //ListenAndServeTLS("./tls/cert.pem", "./tls/key.pem")
	errorLog.Fatal(err)
}
