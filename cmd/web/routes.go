...
func (app *application) routes() http.Handler {
	...
	router.Handler(
		...
		app.sessionManager.LoadAndSave(
			app.authenticate(app.requireAuthentication(http.HandlerFunc(app.snippetSearch))),
		),
	)
	//random
	router.Handler(
		http.MethodGet, "/snippet/random",
		app.sessionManager.LoadAndSave(
			app.authenticate(app.requireAuthentication(http.HandlerFunc(app.snippetRandom))),
		),
	)
	router.Handler(
